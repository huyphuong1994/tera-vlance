...
const ManeuverForm = (props: IProps) => {
  ...
  } = useForm<IFormManeuver>({
    resolver: yupResolver<IFormManeuver>(schema),
    mode: 'onChange',
  });
  ...
  const handleSubmitForm = (values: IFormManeuver): void => {
    if (loadingSubmit) return;
    submitForm(values);
  };
